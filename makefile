...
LDFLAGS+=-L. -g
#^|
EXAMPLESOBJS=  generator.o register.o queue.o main.o generat.o cpu.o transduc.o distri.o com.o linpack.o debug.o trafico.o
#
...
#^|
generator.o: /cygdrive/C/eclipse/workspace/test/generator.cpp
...
#^|
generator.o: /cygdrive/C/eclipse/workspace/test/generator.cpp \
 /cygdrive/C/eclipse/workspace/test/generator.h \
